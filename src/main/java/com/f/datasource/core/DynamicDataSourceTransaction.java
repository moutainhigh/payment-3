...
public class DynamicDataSourceTransaction implements Transaction {
    ...
    public Connection getConnection() throws SQLException {
        String dataSourceKey = DataSourceContextHolder.getDataSourceKey()==null?DataSourceContextHolder.getDefaultDataSourceKey():DataSourceContextHolder.getDataSourceKey();
        if (mainDatabaseKey.equals(dataSourceKey)) {
